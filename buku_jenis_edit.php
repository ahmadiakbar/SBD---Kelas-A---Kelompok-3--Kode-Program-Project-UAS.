...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM jenis_buku WHERE kode_jenis = '$id'";
...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"></script>
        ...
        <form method="POST" action="buku_jenis_update.php">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="jenis_buku" name="jenis_buku" value="<?php echo $jenis_buku; ?>">
            </div>
